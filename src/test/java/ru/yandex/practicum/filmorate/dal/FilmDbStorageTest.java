...
class FilmDbStorageTest {
    ...
    void shouldFindFilmById() {
        ...
        assertThat(filmOptional)
                ...
                .hasValueSatisfying(foundFilm -> {
                    ...
                    assertThat(foundFilm.getDescription()).isEqualTo("Film Description");
                    assertThat(foundFilm.getReleaseDate()).isEqualTo(LocalDate.of(2010, 10, 10));
                    assertThat(foundFilm.getDuration()).isEqualTo(90);
    ...
    void shouldFindAllFilms() {
        ...
        assertThat(films)
                ...
                .containsExactly("Film A", "Film B");
        assertThat(films)
                .extracting(film -> film.getMpa().getId())
                .containsExactly(1, 3);
    }
}